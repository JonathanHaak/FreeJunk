...
const donationRoute = require(path.join(__dirname,"..","station_F@UMN","serveStation.js"));
...
function configureStandby(){
    ...
    /*app.get(["/","/donationPage"], function(req, res){
        res.sendFile(path.join(__dirname,"..","addPage.html"));
    });
    app.get("/walkthrough", function(req, res){
        res.sendFile(path.join(__dirname,"..","fullWalkthrough.html"));
    });
...
function configureRequests(){
    ...
    /*var stationChild = cp.fork(path.dirname(__dirname) +"/station_F@UMN/serveStation.js");
